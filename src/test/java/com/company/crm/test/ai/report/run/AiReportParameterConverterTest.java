...
class AiReportParameterConverterTest extends AbstractTest {
    ...
    void testConvertEntityListInvalidFormat() {
        ...
        assertThat(result.errors().getFirst().errorMessage()).contains("must be a collection");
    }
    ...
    void testUnknownAlias() {
        ...
        assertThat(result.success()).isFalse();
        assertThat(result.errors()).hasSize(1);
        assertThat(result.errors().getFirst().parameterAlias()).isEqualTo("unknownParam");
        assertThat(result.errors().getFirst().errorMessage()).contains("Unknown report parameter alias");
    }
    ...
    void testRequiredParameterMissing() {
        ...
        assertThat(result.success()).isFalse();
        assertThat(result.errors()).hasSize(1);
        assertThat(result.errors().getFirst().parameterAlias()).isEqualTo("reqParam");
    }
